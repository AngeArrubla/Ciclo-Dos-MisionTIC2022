...
public class Requerimiento2 extends JFrame{
    ...
    public String[][] mostrar() throws SQLException{ //crea una matriz
        ...
        ArrayList<Requerimiento_2> lista = new ArrayList<Requerimiento_2>(); //generar objeto crea array que contiene la info del controlado
        ...
        for (int i=0; i< lista.size(); i++){
            matriz[i][0]=lista.get(i).getNombre();//lista tiene todos los objetos por lo tanto con get solicito el dato que necesito
